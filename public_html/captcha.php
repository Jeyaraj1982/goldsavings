<?php include_once("/home/nexifysoftware/public_html/goldsavings.nexifysoftware.in/config.php"); ?>
<?php
//session_start();
class phptextClass
{                   
    ...
    {
        /* settings */
        $font = 'assets/fonts/monofont.ttf';/*define font*/
    ...
    /*for random string*/
    protected function random($characters=6,$letters = '23456789bcdfghkmpqstvwxyz'){
        $str='';
    ...
    $phptextObj->phpcaptcha('#056A9B','#ffffff',120,40,10,25);    
 ?>