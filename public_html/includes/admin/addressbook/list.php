        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align:right"><a href="javascript:void(0)" onclick="confirmationtoDelete(\''+data.ContactID+'\')" class="btn btn-outline-danger btn-sm">Delete</a>&nbsp;&nbsp;<a href="'+URL+'dashboard.php?action=addressbook/edit&edit='+data.ContactID+'" class="btn btn-primary btn-sm">Edit</a>&nbsp;&nbsp;<a href="'+URL+'dashboard.php?action=addressbook/view&edit='+data.ContactID+'" class="btn btn-success btn-sm">View</a></td>'
                      + '</tr>';
            });
            if (obj.length==0){
                html += '<tr> <td colspan="7" style="text-align: center;background:#fff !important">no data found</td></tr>';
            }   
