                ...
                <div class="card-body" style="padding-top:25px">
                    <table id="datatables-fixed-header" class="table table-striped" style="width:100%">
                        ...
                        <tbody id="tbl_content">
                            <tr>
                                <td colspan="7" style="text-align: center;background:#fff !important">Loading branch users ...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
function d() {
    openPopup();
    $.post(URL+ "webservice.php?action=listBranchUsers&method=Users&Branch=<?php echo $data[0]['BranchID']; ?>","",function(data){
        closePopup();
