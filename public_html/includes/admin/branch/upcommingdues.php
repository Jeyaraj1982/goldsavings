...
<div class="col-sm-12">
    <div class="row">
        ...
        <div class="col-6" style="text-align: right;">
            <a href="<?php echo URL;?>dashboard.php?action=branch/all_upcommingdues">All</a>&nbsp;|&nbsp;
            <a href="<?php echo URL;?>dashboard.php?action=branch/customerwise_upcommingdues">Customer Wise</a>&nbsp;|&nbsp;       
            <a href="<?php echo URL;?>dashboard.php?action=branch/salesmanwise_upcommingdues">Salesman Wise</a>&nbsp;|&nbsp;
...
function getData() {
    ...
    openPopup();
    clearDiv(['message']);
    $.post(URL+ "webservice.php?action=getupCommingDues&&BranchID=<?php echo $data[0]['BranchID']; ?>","",function(data){
        closePopup();
