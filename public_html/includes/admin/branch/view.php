...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-6">
            <h1 class="h3">View Branch Information</h1>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12" style="text-align:right;">
                                <a style="color:#888;text-decoration:none;" href="<?php echo URL;?>dashboard.php?action=branch/edit&view=<?php echo $data[0]['BranchID'];?>"><i class="align-middle me-2" data-feather="edit"></i><span class="align-middle">edit</span></a>
                            </div>
             ...
             <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div style="font-weight: bold;">Map URL</div>
                                <?php echo $data[0]['MapURL'];?>
                            </div>
                            <div class="col-sm-6">
