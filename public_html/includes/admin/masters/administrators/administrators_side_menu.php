<div class="card mb-3">
    ...
    <ul style="text-align:left;" class="list-group list-group-flush">
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/administrators/view&administrator=<?php echo $_GET['administrator'];?>">Administrator Info</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/administrators/documents&administrator=<?php echo $_GET['administrator'];?>">Documents</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/administrators/activity&administrator=<?php echo $_GET['administrator'];?>">Activity</a></li> 
    </ul>
