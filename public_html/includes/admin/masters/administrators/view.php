...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-6">
            <h1 class="h3">View Administrator</h1>
        </div>
     <form id="frm_edit" name="frm_edit" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo $data[0]['AdministratorID'];?>" name="AdministratorID">
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-12" style="text-align:right;">
                                <a style="color:#888;text-decoration:none;" href="<?php echo URL;?>dashboard.php?action=masters/administrators/edit&administrator=<?php echo $data[0]['AdministratorID'];?>&fpg=masters/administrators/view&administrator=<?php echo $data[0]['AdministratorID'];?>"><i class="align-middle me-2" data-feather="edit"></i><span class="align-middle">edit</span></a>
                            </div>
                            <div class="col-sm-6 mb-3">
                                <div style="font-weight: bold;">Administrator Code</div>
                                <?php echo $data[0]['AdministratorCode'];?>
                            </div>
                            <div class="col-sm-6 mb-3">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div style="font-weight: bold;">Administrator's Name</div>
                                <?php echo $data[0]['AdministratorName'];?>
                            </div>
                            <div class="col-sm-12 mb-3">
