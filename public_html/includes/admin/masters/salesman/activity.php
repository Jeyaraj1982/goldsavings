    ...
    <div class="row">
        <div class="col-6">
         ...
         <div class="col-6" style="text-align:right;">
            <a href="<?php echo URL;?>dashboard.php?action=masters/salesman/list" class="btn btn-outline-primary btn-sm">Back</a>
     </div>
    </div>
    <div class="row">
...
function listActivities() {
    openPopup();
    $.post(URL+ "webservice.php?action=ViewAllActivities&method=Salesman&ID=<?php echo $data[0]['SalesmanID']; ?>","",function(data){
        closePopup();
