<div class="container-fluid p-0">
     <div class="row">
        <div class="col-6">
            <h1 class="h3">Contracts List By Scheme</h1>
...
function d() {
    openPopup();
    $.post(URL+ "webservice.php?action=listBySchemes&method=Contracts&SchemeID=<?php echo $_GET['SchemeID']; ?>","",function(data){
        closePopup();
                             ...
                             + '<td style="text-align:right">' 
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=masters/schemes/view&edit='+data.SchemeID+'&fpg=masters/schemes/list_contractsbyscheme&SchemeID='+data.SchemeID+'">View Scheme</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=../common/contracts/view&view='+data.ContractCode+'&fpg=masters/schemes/list_contractsbyscheme&SchemeID='+data.SchemeID+'">View Contract</a>'
                           ...
                           + '<td>' + data.ContractCode + '</td>'
                            ...
                            + '<td>' + ( (data.IsActive=="1") ? "<span class='badge bg-success'>Active</span>" : "<span class='badge bg-secondary'>Disabled</span>" ) + '</td>'
                             + '<div class="dropdown position-relative">'
                                        ...
                                        + '</a>'
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=contracts/list_contractsbyscheme&ContractID='+data.SchemeID+'">View</a>'
                                                + '<a class="dropdown-item" href="javascript:void(0)" onclick="confirmationtoDelete(\''+data.SchemeID+'\')">Delete</a>'
                                        + '</div>'
                                + '</div>'
                            + '</td>'
