                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-1">
                                <input class="form-check-input" type="checkbox" value="1" id="UserCode" name="UserCode" onclick="OrderByContent()">&nbsp;
                                User ID
                            </div>
                            <div class="col-sm-4 mb-1">
                                <input class="form-check-input" type="checkbox" value="1" id="UserName" name="UserName"  onclick="OrderByContent()">&nbsp;
                                User Name
                            </div>
                            <div class="col-sm-4 mb-1">
                            ...
                            <script>
                                function printUserrole() {
                                    OrderByContent();
                                    var checkBox = document.getElementById("UserRole");
                                    var div = document.getElementById("selectUserRole");
                                    if (checkBox.checked == true){
                                        div.style.display = "block";
                                    } else {
                                        div.style.display = "none";
                            ...
                            <div class="col-sm-4 mb-1">
                                <input class="form-check-input" type="checkbox" value="1" id="UserRole" name="UserRole" onclick="printUserrole()">&nbsp;
                                User Role
                                <div style="display:none" id="selectUserRole">
                                    <div class="input-group">
                                        <select data-live-search="true" data-size="5" name="UserRoleID" id="UserRoleID" class="form-select mselect">
                            ...
                            <div class="col-12">
                                ...
                                function printUsername() {
                                    OrderByContent();
                                 var checkBox = document.getElementById("UserNameS");
                                ...
                                <div class="col-sm-6">
                                  <input class="form-check-input" type="checkbox" value="1" id="UserNameS" name="UserNameS" onclick="printUsername()">&nbsp;
                                    User Name
                                <div style="display:none" id="selectUserName">
                                    <div class="input-group">
                                        <select class="form-select" name="selectUserFilter" id="selectUserFilter" style="width: 110px !important;
  flex: inherit;">
                                            <option value="0">Any</option>
                                            <option value="Startwith">Start with</option>
                                            <option value="Endwith">End with</option>
                                        </select>
                                        <input type="text" name="SearchUserName" id="SearchUserName" class="form-control" placeholder="User Name">
                                    </div>
                                </div>
                            </div>
                                <div class="col-sm-6">
...
function listUserRoles() {
    ...
    $.post(URL+ "webservice.php?action=listAllActive&method=UserRoles","",function(data){
        var obj = JSON.parse(data);
        if (obj.status=="success") {
            var html = "<option value='0'> All User Roles</option>";
            $.each(obj.data, function (index, data) {
...
function OrderByContent() {
     ...
     if ($('#UserName').prop("checked")|| $('#UserNameS').prop("checked")) {
        html += "<option value='UserName'>User Name</option>";
     }
     if ($('#UserCode').prop("checked")) {
        html += "<option value='UserCode'>User ID</option>";
     }
     if ($('#FatherName').prop("checked")) {
        html += "<option value='FatherName'>Father/Husband Name</option>";
     }
     if ($('#UserRole').prop("checked")) {
        html += "<option value='UserRoleID'>User Role</option>";
     }
...
function getData() {
    ...
    openPopup();
    clearDiv(['EntryDateC','message']);
    $.post(URL+ "webservice.php?action=listCustomize&method=Users",param,function(data){
        closePopup();
        var obj = JSON.parse(data);
        var column_count=0;
        if (obj.status=="success") {
            ...
            if ($('#UserCode').prop("checked")) {
                header += "<th>User ID</th>";
                column_count++;
            }
            if ( $('#UserName').prop("checked") || $('#UserNameS').prop("checked")   ) {
                header += "<th>User Name</th>";
                column_count++;
            }
            if ($('#FatherName').prop("checked")) {
