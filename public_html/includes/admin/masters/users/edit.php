        ...
        <div class="col-6 mb-3" style="text-align:right;">  
         ...
         <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" value="<?php echo $data[0]['UserCode'];?>" disabled="disabled"  class="form-control">
                        ...
                        <span id="ErrEntryDate" class="error_msg"></span>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" readonly="readonly" value="<?php echo date("d-m-Y",strtotime($data[0]['DateOfBirth']));?>" name="DateOfBirth" id="DateOfBirth" class="form-control" placeholder="Date Of Birth">
            ...
            <?php 
                ...
                <button onclick="confirmationtoUpdate()" type="button" class="btn btn-primary">Update User</button>
               </div>
            </form>
        </div>
...
function doUpdate() {
    ...
    openPopup();
    clearDiv(['EntryDate','UserCode','FatherName','Gender','DateOfBirth','PancardNumber','AadhaarCardNumber','UserName','EmailID','MobileNumber','WhatsappNumber','AddressLine1','AddressLine2','PinCode','StateNameID','DistrictNameID','AreaNameID','LoginUserName','LoginPassword','Remarks','IsActive']);
    
    jQuery.ajax({
        type: 'POST',
        url:URL+"webservice.php?action=doUpdate&method=Users",
