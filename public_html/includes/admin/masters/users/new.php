                        ...
                        <div class="row">
                             <div class="col-sm-6 mb-3">
                                <label class="form-label">User Role <span style='color:red'>*</span></label>
                                    <select data-live-search="true" data-size="5" name="UserRoleID" id="UserRoleID" class="form-select mstateselect" onchange="printLable()">
                            ...
                            <div id="Branchlist" style="display: none;">
                                ...
                                <select data-live-search="true" data-size="5" name="BranchID" id="BranchID" class="form-select mselect" style="width: 100%">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" value="<?php echo SequnceList::getNextNumber("_tbl_masters_users");?>" name="UserCode" id="UserCode" class="form-control" placeholder="User ID" oninput="this.value=this.value.toUpperCase()" maxlength="20">
                                <span id="ErrUserCode" class="error_msg"></span>
                            </div>
                            <script>
                                function printLable() {
                                    if ($('#UserRoleID').val()=="0"){
                                    ...
                                    if ($('#UserRoleID').val()=="branchadmin"){
                                        $('#Branchlist').show();
                                    }
                                    if ($('#UserRoleID').val()=="branchuser"){
                                        $('#Branchlist').show();
                                    }
                                    if ($('#UserRoleID').val()=="subadmin"){
                                        $('#Branchlist').hide();
                                    }
                                }
                                </script>
                           <div class="col-sm-6 mb-3">
                            ...
                            <div class="col-sm-12 mb-3">
                                <label class="form-label">User Name <span style='color:red'>*</span>
                                <img src="<?php echo URL;?>assets/question.png" style="width: 12px;" class="dropdown"  id="dropdownMenuButton1" data-bs-toggle="dropdown">
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="padding:0px;">
                                    <div class="myheader">User Name</div>
                                    <div class="mycontainer">
...
function addNew() {
   $('#confirmation').modal("hide"); 
    ...
    openPopup();
    clearDiv(['EntryDate','UserCode','FatherName','Gender','DateOfBirth','UserRoleID','UserName','EmailID','MobileNumber','PancardNumber','AadhaarCardNumber','WhatsappNumber','AddressLine1','AddressLine2','PinCode','StateNameID','DistrictNameID','AreaNameID','LoginUserName','LoginPassword','Remarks','IsActive']);
    
    jQuery.ajax({
        type: 'POST',
        url:URL+"webservice.php?action=addNew&method=Users",
...
function listUserRoles() {
    ...
    $.post(URL+ "webservice.php?action=listAllActive&method=UserRoles","",function(data){
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<option value="'+data.Module+'">'+data.UserRole+'</option>';
            });   
