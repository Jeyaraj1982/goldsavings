    ...
    <div class="row">
        <div class="col-6">
         ...
         <div class="col-6" style="text-align:right;">
            <a href="<?php echo URL;?>dashboard.php?action=profile/profile" class="btn btn-outline-primary btn-sm">Back</a>
     </div>
    </div>
    <div class="row">
...
function listActivities() {
    openPopup();
    $.post(URL+ "webservice.php?action=ViewAllActivities&method=Administrators","",function(data){
        closePopup();
