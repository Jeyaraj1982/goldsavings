    ...
    <form id="frm_create" name="frm_create" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-sm-9 mb-3" style="text-align:right;">
                <button  type="button" onclick="Confirmationtoadd()" class="btn btn-primary">View Recipt</button>    
            </div>
             
            <div class="col-sm-12" style="text-align:right;">
                <button  type="button" onclick="NewReciptModal()" class="btn btn-primary">New Pay</button>    
            </div>
...
<div class="modal fade" id="newreciptform" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-sm-12 mb-3">
            ...
            <input type="text" disabled="disabled" name="Name" id="Name" class="form-control" placeholder="Name">
            <span id="ErrName" class="error_msg"></span>
        </div>
        <div class="col-sm-12 mb-3">
            <label class="form-label">Scheme </label>
            <input type="text" disabled="disabled" name="Scheme" id="Scheme" class="form-control" placeholder="Scheme">
            <span id="ErrScheme" class="error_msg"></span>
        </div>
        <div class="col-sm-12 mb-3">
            <label class="form-label">Outstanding </label>
            <input type="text" disabled="disabled" name="Outstanding" id="Outstanding" class="form-control" placeholder="Outstanding">
            <span id="ErrOutstanding" class="error_msg"></span>
        </div>
        ...
        <div class="col-sm-6 mb-3">
            <label class="form-label">Gram <span style='color:red'>*</span></label>
            <input type="text" readonly="readonly" name="Gram" id="Gram" class="form-control" placeholder="Gram">
            <span id="ErrGram" class="error_msg"></span>
        </div>
        </div>
        </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" onclick="paynew()" class="btn btn-primary">Pay New</button>
      </div>
    </div>
  </div>
</div>
...
function NewReciptModal(){
   $('#newreciptform').modal("show");  
 }
function paynew() {
     $('#newreciptform').modal("hide");
    var param = $('#frm_newrecipt_creat').serialize();
    openPopup();
    clearDiv(['Name','Scheme','Outstanding','Payable']);
   $.post(URL+"webservice.php?action=addNew&method=Recipts",param,function(data){
        var obj = JSON.parse(data); 
        if (obj.status=="success") {
            $('#frm_create').trigger("reset");
            if (obj.Recipt.length>3) {
                $('#ReciptID').val(obj.Recipt);
            }
