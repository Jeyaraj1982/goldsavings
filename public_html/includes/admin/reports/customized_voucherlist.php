                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-1">
                                <input class="form-check-input" type="checkbox" value="1" id="GoldInGram" name="GoldInGram" onclick="OrderByContent()">&nbsp;
                                Gold 
                            </div>
                            <div class="col-sm-4 mb-1">
...
function OrderByContent() {
     ...
     if ($('#GoldInGram').prop("checked")) {
        html += "<option value='GoldInGram'>Gold</option>";
     }
