<div class="container-fluid p-0">
    ...
    <div class="row">
        <div class="col-12 col-xl-6">
            <div class="card">
                <div class="card-body">
                    <?php $data = $mysql->select("select * from _tbl_master_areanames where AreaNameID='".$_GET['edit']."'"); ?>
                    <form id="frm_edit" name="frm_edit">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12" style="text-align:right;">
                                ...
                                <button onclick="doUpdate()" type="button" class="btn btn-primary">Update Area Name</button>
                            </div>
                        </div>
                    </form>
                </div>
