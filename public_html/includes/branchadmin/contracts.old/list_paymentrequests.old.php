        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align: right">' + data.BankReferenceNumber + '</td>'
                            ...
                            html+= '<td style="text-align:right"><a href="'+URL+'dashboard.php?action=contracts/viewrecentpayment&id='+data.PaymentRequestID+'" class="btn btn-outline-primary btn-sm">View</a></td>' 
                + '</tr>';
