...
<div class="modal fade" id="Dueconfirmation" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="row">
         <div class="col-sm-6 mb-3">
            ...
            <div class="input-group">
                <input type="text" value="<?php echo date("d-m-Y");?>" name="PaymentDate" id="PaymentDate" class="form-control" placeholder="Payment Date">
