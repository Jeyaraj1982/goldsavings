        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align:right"><a href="'+URL+'dashboard.php?action=customers/view&customer='+data.CustomerID+'" class="btn btn-outline-primary btn-sm" style="font-size:10px">View</a></td>'
                      + '</tr>';
           });
