<div class="container-fluid p-0">
    <div class="row">
        <div class="col-6">
            ...
            <h6 class="card-subtitle text-muted mb-3">List all Users</h6>
        </div>
                ...
                <div class="card-body" style="padding-top:25px">
                    <table id="datatables-fixed-header" class="table table-striped" style="width:100%">
                        ...
                        <tbody id="tbl_content">
                            <tr>
                                <td colspan="7" style="text-align: center;background:#fff !important">Loading users ...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
function d() {
    openPopup();
    $.post(URL+ "webservice.php?action=ListAll&method=Users","",function(data){
        closePopup();
