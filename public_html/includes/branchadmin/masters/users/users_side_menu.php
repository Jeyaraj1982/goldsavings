<div class="card mb-3">
    <div class="card-body text-center">
        ...
        <h4 class="card-title mb-0"><?php echo $data[0]['UserName'];?></h4>
        <div class="text-muted mb-2"><?php echo $data[0]['UserCode'];?></div>
        <div>
            <!--
    ...
    <ul style="text-align:left;" class="list-group list-group-flush">
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/users/view&user=<?php echo $_GET['user'];?>">User Info</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/users/branchinfo&user=<?php echo $_GET['user'];?>">Branch Info</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/users/documents&user=<?php echo $_GET['user'];?>">Documents</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/users/managerole&user=<?php echo $_GET['user'];?>">Manage Role</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=masters/users/activity&user=<?php echo $_GET['user'];?>">Activity</a></li> 
    </ul>
