                ...
                html += '<tr>'
                           ...
                           + '<td style="text-align:right">' 
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=masters/customers/view&customer='+data.CustomerID+'&fbg=reports/salesmanwise_pendingdues">View Customer</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=contracts/view&view='+data.ContractCode+'&fbg=reports/salesmanwise_pendingdues">View Contract</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=masters/schemes/view&edit='+data.SchemeID+'&fbg=reports/salesmanwise_pendingdues">View Scheme</a>'
