<div class="card mb-3">
    <div class="card-body text-center">
        ...
        <h4 class="card-title mb-0"><?php echo $data[0]['EmployeeName'];?></h4>
        <div class="text-muted mb-2"><?php echo $data[0]['EmployeeCode'];?></div>
        <div>
            <!--
    ...
    <ul style="text-align:left;" class="list-group list-group-flush">
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=employees/view&employees=<?php echo $_GET['employees'];?>">Employee Info</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=employees/documents&employees=<?php echo $_GET['employees'];?>">Documents</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=employees/activity&employees=<?php echo $_GET['employees'];?>">Activity</a></li> 
    </ul>
