                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                <label class="form-label">Branch ID <span style='color:red'>*</span></label>
                                <input type="text" value="<?php echo SequnceList::getNextNumber("_tbl_masters_branches");?>" name="BranchCode" id="BranchCode" class="form-control" placeholder="Branch Code">
