                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-1">
                                <input class="form-check-input" type="checkbox" value="1" id="SalesmanName" name="SalesmanName"  onclick="OrderByContent()">&nbsp;
                                Salesman Name
                            </div>
                            <div class="col-sm-4 mb-1">
                            ...
                            <div class="col-12">
                                ...
                                <script>
                                function printSalesmanname() {
                                    OrderByContent();
                                 var checkBox = document.getElementById("SalesmanNameS");
                                 var div = document.getElementById("selectSalesmanName");
                                   if (checkBox.checked == true){
                                        div.style.display = "block";
                                      } else {
                                        div.style.display = "none";
                                ...
                                <div class="col-sm-6">
                                  <input class="form-check-input" type="checkbox" value="1" id="SalesmanNameS" name="SalesmanNameS" onclick="printSalesmanname()">&nbsp;
                                    Salesman Name
                                <div style="display:none" id="selectSalesmanName">
                                    <div class="input-group">
                                        <select class="form-select" name="selectSalesmanFilter" id="selectSalesmanFilter" style="width: 110px !important;
  flex: inherit;">
                                            <option value="0">Any</option>
                                            <option value="Startwith">Start with</option>
                                            <option value="Endwith">End with</option>
                                        </select>
                                        <input type="text" name="SearchSalesmanName" id="SearchSalesmanName" class="form-control" placeholder="Salesman Name">
                                    </div>
                                </div>
                            </div>
                                <div class="col-sm-6">
...
function OrderByContent() {
     ...
     if ($('#SalesmanCode').prop("checked")) {
        html += "<option value='SalesmanCode'>Salesman ID</option>";
     }
...
function getData() {
    ...
    openPopup();
    clearDiv(['EntryDate','message']);
    $.post(URL+ "webservice.php?action=listCustomize&method=Salesman",param,function(data){
        closePopup();
        var obj = JSON.parse(data);
        var column_count=0;
        if (obj.status=="success") {
            ...
            if ($('#SalesmanCode').prop("checked")) {
                header += "<th>Salesman ID</th>";
                column_count++;
            }
            if ( $('#SalesmanName').prop("checked") || $('#SalesmanNameS').prop("checked")   ) {
                header += "<th>Salesman Name</th>";
                column_count++;
            }
            if ($('#FatherName').prop("checked")) {
