            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" disabled="disabled" value="<?php echo $data[0]['BranchName'];?>"  class="form-control">
                            </div>
...
function doUpdate() {
    ...
    openPopup();
    clearDiv(['EntryDate','SalesmanCode','FatherName','Gender','PancardNumber','AadhaarCardNumber','DateOfBirth','SalesmanName','EmailID','MobileNumber','WhatsappNumber','AddressLine1','AddressLine2','PinCode','StateNameID','DistrictNameID','AreaNameID','LoginUserName','LoginPassword','Remarks','IsActive']);    
    jQuery.ajax({
        type: 'POST',
