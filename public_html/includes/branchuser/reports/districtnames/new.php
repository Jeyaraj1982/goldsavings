                    ...
                    <form id="frm_create" name="frm_create">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" value="<?php echo SequnceList::getNextNumber("_tbl_master_districtnames");?>" name="DistrictNameCode" id="DistrictNameCode" class="form-control" placeholder="District Name Code">
                            ...
                            <div class="col-sm-12" style="text-align:right;">
                                ...
                                <button onclick="addNew()" type="button" class="btn btn-primary">Create District Name</button>
                            </div>
                        </div>
                    </form>
                </div>
