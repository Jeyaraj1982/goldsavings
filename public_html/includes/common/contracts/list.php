...
<div class="col-sm-12">
    <div class="row">
        ...
        <div class="col-6" style="text-align:right;">
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/new" class="btn btn-primary btn-sm">New Contract</a>
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/customized_contractlist" class="btn btn-warning btn-sm">Customize Columns</a>
        </div>
     </div>
</div>
     <div class="row">
                        ...
                        + '<td style="text-align:right;">'
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=../common/contracts/view&view='+data.ContractCode+'&fpg=../common/contracts/list" >View</a>'
                                        html += '</div>'
                                + '</div>'
                            + '</td>'                                                                                                    
                      + '</tr>';
