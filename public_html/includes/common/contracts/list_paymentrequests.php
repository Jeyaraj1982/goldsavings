...
<div class="container-fluid p-0">
     <div class="row">
        ...
        <div class="col-6" style="text-align: right;">
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/list_paymentrequests&type=request">Requested</a> | 
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/list_paymentrequests&type=approved">Approved</a> | 
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/list_paymentrequests&type=rejected">Rejected</a> | 
            <?php   
