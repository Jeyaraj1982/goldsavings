<div class="container-fluid p-0">
    ...
    <form id="frm_create" name="frm_create" method="post" enctype="multipart/form-data">
        <div class="row"  style="max-width:980px">
            ...
            <div class="col-12 col-xl-12">
                <div class="card" id="CustomerInformation" style="display: none;">
                    <div class="card-body" style="padding-bottom:0px">
                        <div class="row">
            ...
            <div class="col-12 col-xl-12" id="SchemeInformation" style="display: none;">
                <div class="card">
                    <div class="card-body" style="padding-bottom:0px;">
                        <div class="row">
                            <div class="col-sm-12 mb-3">
            ...
            <div class="col-12 col-xl-12" id="contractinformation" style="display: none;">
                <div class="card">
                    <div class="card-body" style="padding-bottom:0px;">
                        <div class="row">
                        <div class="col-sm-4 mb-3">
                            ...
                            <div class="col-sm-4 mb-3">
                                ...
                                <input type="text" style="text-align: right;" name="Duration" id="Duration" class="form-control" placeholder="0" onclick="getAddFundForm()" onfocus="getAddFundForm()" onkeyup="getTotalAmount()">
                            </div>
                            ...
                            <script>
                                ...
                                function getAddFundForm() {
                                      $('#PaymentDetails').show();
                                      addFundDetailsSubmit();
                                      $('#SubmitContract').removeAttr("disabled"); 
                                }
                                </script>
                                <div class="col-sm-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" readonly="readonly" style="text-align: right; "name="Amount" id="TotalAmount" class="form-control" placeholder="0">
                                </div>
                                <script>
                                ...
                                <div id="Gold_benefits">
                                    ...
                                    <select class="form-select" name="MaterialType" id="MaterialType" onchange="calculateGold()" onclick="getAddFundForm()" onfocus="getAddFundForm()">
            ...
            <div class="col-12 col-xl-12 mt-2" id="PaymentDetails" style="display: none;">
            ...
            <div class="col-sm-12" style="text-align:right;color:red" id="ErrMessage"  >
            </div>
            <div class="col-sm-12" style="text-align:right;">
                <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/list" class="btn btn-outline-primary">Back</a>
                <button type="button" disabled="disabled" id="SubmitContract" onclick="Confirmationtoadd()" class="btn btn-primary" style="margin-left: 10px;">Create Contract</button>  
            </div>
        </div>                
    </form>
</div>
        ...
        if ( (item.text.substr(0, val.length).toUpperCase() == val.toUpperCase()) ||  (item.MobileNumber.substr(0, val.length).toUpperCase() == val.toUpperCase()) ||  (item.CustomerID.substr(0, val.length).toUpperCase() == val.toUpperCase()) ) {
          ...
          b.addEventListener("click", function(e) {
              ...
              txtHtml = '<div class="row">'
                                    ...
                                    + '</div>'
                                    + '<div class="col-sm-4">'
                                        + '<label class="form-label" style="font-weight:bold;margin-bottom:0px !important">Wallet Balance</label><br>'
                                        + '<span>₹</span>&nbsp;' + item.WalletBalance
                                    + '</div>'
                                    ...
                                    + '</div>'
                                    + '<div class="col-sm-12" style="text-align:right;">'
                                        + '<!--<a href="'+URL +'dashboard.php?action=../common/view&edit='+item.value+'" class="btn btn-outline-primary btn-sm" target="_blank">View Details</a>-->'
                                        + '<a href="'+URL+'dashboard.php?action=../common/customers/view&customer='+item.CustomerID+'&fpg=../common/contracts/new" class="btn btn-outline-primary btn-sm">View Details</a>'
                                    + '</div>';
             $('#CustomerResult').html(txtHtml) ;
             $('#customersince').html(daysdifference(0,item.CreatedOn));
             $('#CustomerResult').show() ;
             $('#SchemeInformation').show() ;
              $('#ErrCustomerID').html("");
...
clearDiv(['CustomerName','MobileNumber','PaymentModeID','EntryDate','DueAmount','Amount','Duration','InstallmentMode','InstallmentAmount','MaterialType','ModeOfBenifits','Remarks','IsActive']);
    ...
    if (parseFloat($('#DueAmount').val())>parseFloat($('#ReceivedAmt').html())) {
        $('#ErrMessage').html("Due amount is greater than recevied amount");
...
function opencontractview()  {
  ...
  location.href=URL +'dashboard.php?action=../common/contracts/view&view='+CreatedContractID;  
}
setTimeout(function(){
    listpaymentmodes();
    getGoldRate();
...
function getGoldRate() {
    ...
    $.post(URL+"webservice.php?action=getGoldRate&method=goldRates&date="+$('#EntryDate').val(),"",function(data){
        ...
        if (obj.status=="success") {
            ...
            $('#ErrEntryDate').html(obj.message);
            $('#CustomerInformation').hide();
            $('#SchemeInformation').hide();
