...
function listContracts(_customerID) {
    ...
    openPopup();
    $.post(URL+ "webservice.php?action=listCustomerWise&method=Contracts&CustomerID="+_customerID,param,function(data){
        closePopup();
          ...
          b.addEventListener("click", function(e) {
              ...
              txtHtml = '<div class="row">'
                                    ...
                                    + '<div class="col-sm-12" style="text-align:right;">'
                                        ...
                                        + '<a href="'+URL+'dashboard.php?action=masters/customers/view&customer='+item.CustomerID+'&fpg=../common/customers/searchcustomers" class="btn btn-outline-primary btn-sm">View Details</a>'
                                    + '</div>';
