...
<div class="col-sm-12">
    <div class="row">
        <div class="col-6">
            <h1 class="h3">Customers created by me</h1>
...
function ListallCustomers() {
    ...
    openPopup();
    $.post(URL+ "webservice.php?action=ListAll&method=Customers&filter=CreatedByMe","",function(data){
        closePopup();
                            ...
                            + '<td style="text-align:right">' 
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                ...
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=reports/receipt&customer='+data.CustomerID+'&fpg=../common/customers/list">View Receipts</a>'
