    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 mb-3">
            ...
            <input type="text" name="NomineeName" id="NomineeName" class="form-control" placeholder="Nominee Name" maxlength="50">
        ...
        <div class="col-sm-6 mb-3">
            <label class="form-label">Age <span style='color:red'>*</span>
            <img src="<?php echo URL;?>assets/question.png" style="width: 12px;" class="dropdown"  id="dropdownMenuButton1" data-bs-toggle="dropdown">
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="padding:0px;">
                    <div class="myheader">Age</div>
                    <div class="mycontainer">
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align:right"><a onclick="view(\''+data.NomineeID+'\')" class="btn btn-outline-primary btn-sm">View</a></td>'
                      + '</tr>';
             });
