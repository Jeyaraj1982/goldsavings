...
<div class="container-fluid p-0">
    <div class="row">
        ...
        <div class="col-6" style="text-align: right;">
            <a href="<?php echo URL;?>dashboard.php?action=../common/customers/payments&type=request&customer=<?php echo $_GET['customer'];?>">Requested</a> | 
            <a href="<?php echo URL;?>dashboard.php?action=../common/customers/payments&type=approved&customer=<?php echo $_GET['customer'];?>">Approved</a> | 
            <a href="<?php echo URL;?>dashboard.php?action=../common/customers/payments&type=rejected&customer=<?php echo $_GET['customer'];?>">Rejected</a> | 
            <a href="<?php echo URL;?>dashboard.php?action=../common/customers/payments&type=all&customer=<?php echo $_GET['customer'];?>">All</a>
        </div>
    </div>
    <div class="row">
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            html+= '<td style="text-align:right"><a href="'+URL+'dashboard.php?action=../common/customers/viewrecentpayment&id='+data.PaymentRequestID+'&customer=<?php echo $_GET['customer'];?>" class="btn btn-outline-primary btn-sm">View</a></td>' 
                + '</tr>';
