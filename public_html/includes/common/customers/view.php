                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-12" style="text-align:right;">
                                <a style="color:#888;text-decoration:none;" href="<?php echo URL;?>dashboard.php?action=../common/customers/edit&customer=<?php echo $data[0]['CustomerID'];?>&fpg=../common/customers/view&customer=<?php echo $data[0]['CustomerID'];?>"><i class="align-middle me-2" data-feather="edit"></i><span class="align-middle">edit</span></a>
                            </div>
                            ...
                            <div class="col-sm-6 mb-3">
                            <span style="font-weight: bold;">Wallet balance<span>(₹)</span>&nbsp;</span><span><a style="text-decoration:none;" href="javascript:void(0)" onclick="addFundForm('<?php echo $data[0]['CustomerID'];?>')"><span class="align-middle">Add fund</span></a> </span>
                                <?php echo number_format($data[0]['WalletBalance'],2);?>
                            </div>
                            <div class="col-sm-6 mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-6">         
                                ...
                                <?php 
                                    if (strlen($data[0]['ReferByText'])>0) {
                                        echo " ".$data[0]['ReferByText'];  
                                    } else {
                                       echo "N/A";     
                                    }
                                ?>
                            ...
                            <div class="col-sm-6">
                                <div style="font-weight: bold">Referred By Name</div>
                                <?php 
                                    if (strlen($data[0]['ReferredByName'])>0) {
                                        echo " ".$data[0]['ReferredByName'];  
                                    } else {
                                       echo "N/A";     
                                    }
                                ?>
                                ...
                                <div style="font-weight: bold">Mobile Number</div>
                                <?php 
                                    if (strlen($data[0]['RefMobileNumber'])>0) {
                                        echo "+91 ".$data[0]['RefMobileNumber'];  
                                    } else {
                                       echo "N/A";     
                                    }
                                ?>
...
<?php include_once(SERVER_PATH."/includes/view/addfund.php");?>