<div class="container-fluid p-0">
    <div class="row">
        ...
        <div class="col-sm-6  mb-2" style="text-align:right;">
            <a href="<?php echo URL;?>dashboard.php?action=../common/contracts/list" class="btn btn-outline-primary btn-sm">Back</a> &nbsp;
...
function getData(){
    ...
    $.post(URL+ "webservice.php?action=getData&method=Contracts&contract=<?php echo $_GET['view'];?>","",function(data){
        ...
        if (obj.status=="success") {
            ...
            var html="";
            $('#viewcustomer'). attr ("href","<?php echo URL;?>dashboard.php?action=../common/customers/view&customer="+CustomerData.CustomerID);
            ...
            $('#CreatedByName').html(ContractData.CreatedByName);
             if(ContractData.IsActive=="1"){
                ...
                if(ContractData.VoucherID=="0"){
                 ...
                 $('#ContractAdditionalInformation').html('<a href="'+URL+'dashboard.php?action=../common/contracts/voucher&number='+ContractData.VoucherNumber+'" class="btn btn-outline-primary btn-sm">View Voucher</a>');   
                }
