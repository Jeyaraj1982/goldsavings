            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-9 mb-3">
                                ...
                                <button type="button" onclick="getData()" class="btn btn-primary" style="z-index:0">Get Rate</button>
                            </div> 
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body" style="padding:0px">
                    <table id="datatables-fixed-header" class="table table-striped" style="width:100%;border:1px solid #ccc;margin-bottom:0px">
                       <thead>
                            <tr>
                                <th style="">Date</th>
                                <th style="width:23%; text-align: right;">18kt</th>
                                <th style="width:23%; text-align: right;">22kt</th>
                                <th style="width:23%; text-align: right;">24kt</th>
                                <th style="width:23%; text-align: right;">Silver</th>
                            </tr>
                        </thead>
                        <tbody id="tbl_content">
                            <tr>
                                <td colspan="5" style="text-align: center;background:#fff !important">Loading Gold & silver price ...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    $.post(URL+ "webservice.php?action=listAll&method=goldRates",param,function(data){
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            + '<td style=";padding:2px  5px;">' + data.Date + '</td>'
                            + '<td style="text-align:right;padding:2px 5px;">' + data.GOLD_18 + '</td>'
                            + '<td style="text-align:right;padding:2px 5px;">' + data.GOLD_22 + '</td>'
                            + '<td style="text-align:right;padding:2px 5px;">' + data.GOLD_24 + '</td>'
                            + '<td style="text-align:right;padding:2px 5px;">' + data.SILVER + '</td>'
                            + '</tr>';
            });
