<div class="container-fluid p-0">
    <div class="col-sm-12">
        <div class="row">
        <div class="col-9">
            <h1 class="h3">Active Contracts</h1>
        </div>
...
function loadContracts() {
    openPopup();
    $.post(URL+ "webservice.php?action=ListAllActive&method=Contracts","",function(data){
        closePopup();
                                        ...
                                        + '<div class="col-6" style="text-align:right">'
                                             + '<div class="dropdown position-relative">'
                                                ...
                                                + '<div class="dropdown-menu dropdown-menu-end">'
                                                    + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=contracts/viewactivecontract&view='+data.ContractCode+'&fpg=contracts/active"">View Contract</a>'
                                                    + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=schemes/view&edit='+data.SchemeID+'&fpg=contracts/active">View Scheme</a>';
