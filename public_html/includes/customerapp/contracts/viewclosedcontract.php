<div class="container-fluid p-0">
    <div class="row">
        ...
        <div class="col-6 mb-1" style="text-align: right;">
            <a href="<?php echo URL;?>dashboard.php?action=contracts/closed" class="btn btn-outline-primary btn-sm">Back</a>&nbsp;
                        ...
                        <div class="col-6" style="text-align: right;padding-top:5px">
                            <table align="right">
                                <tr>
                                    ...
                                    <td style="line-height: 12px;text-align: right;"><span style="text-align: right;"><b id="GoldInGram"></b><br><span style="font-size:10px">Gms</span></span></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-6">
                                       ...
                                       html += '<div class="row">'
                                           ...
                                           */
                                           ...
                                           + '</div>'
                                            + '<div class="col-6">'
                                                + '<div style="font-weight: bold;">Due Amount</div>'
                                                + '<div>' + duedata.DueAmount + '</div>'
                                           + '</div>'
                                           + '<div class="col-6" style="text-align:right;padding-top:10px">';
                                            if  (duedata.IsShowPayButton=="1") {
                                                html+= '<a href="javascript:void(0)" onclick="paymentForm(\''+duedata.DueID+'\',\''+duedata.DueNumber+'\',\''+duedata.DueAmount+'\')" class="btn btn-outline-primary btn-sm">Pay</a>';
                                            }
                                            html += '</div>'
                                            html+='</div>';
