...
function d() {
    openPopup();
    $.post(URL+ "webservice.php?action=listBySchemes&method=Contracts&SchemeID=<?php echo $_GET['view'];?>","",function(data){
        closePopup();
                ...
                html += '<tr>'
                            ...
                            + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=contracts/viewcontract&view='+data.ContractCode+'&fpg=contracts/contractslist_byscheme&view='+data.SchemeID+'">View Contract</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=schemes/view&edit='+data.SchemeID+'&fpg=contracts/contractslist_byscheme&view='+data.SchemeID+'">View Scheme</a>';
                                                if (parseInt(data.Receipts)>0) {
                                                    html +=  '<a class="dropdown-item" href="'+URL+'dashboard.php?action=receipts/receipt&contract='+data.ContractCode+'&fpg=contracts/contractslist_byscheme&view='+data.SchemeID+'">View Receipts</a>';
                                                } else {
                                                    html +=  '<a class="dropdown-item" href="javascript:void(0)" style="color:#aaa">View Receipts</a>';
                                                }
                                                
                                                if (data.VoucherNumber!="") {
                                                    html +=  '<a class="dropdown-item" href="'+URL+'dashboard.php?action=vouchers/viewvoucher&number='+data.VoucherNumber+'&fpg=contracts/contractslist_byscheme&view='+data.SchemeID+'">View Voucher</a>';
                                                } else {
