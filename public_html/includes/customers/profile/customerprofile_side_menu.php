<div class="card mb-3">
 ...
 <div>
        ...
        <h4 class="card-title mb-0" id="customer_name"><?php echo $_SESSION['User']['CustomerName'];?></h4>
        <div class="text-muted mb-2" id="customer_type"><?php echo $_SESSION['User']['CustomerName'];?></div>
        <div>
            <!--
