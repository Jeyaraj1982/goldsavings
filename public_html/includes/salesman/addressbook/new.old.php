                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" readonly="readonly" value="<?php echo SequnceList::getNextNumber("_tbl_apps_addressbook");?>" name="ContactCode" id="ContactCode" class="form-control" placeholder="Contact Code">
