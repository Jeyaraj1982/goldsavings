      ...
      <div class="modal-header">
        ...
        <div class="row">
         <div class="col-sm-6 mb-3">
            ...
            <div class="col-sm-4 mb-3">
                <label class="form-label" style="display: none;">Gold in Grams </label>
            ...
            <div class="col-sm-8  mb-3">
                <label class="form-label" style="display: none;">Payment Mode<span style='color:red'>*</span></label>
            ...
            <div class="col-sm-12 mb-3">
                <label class="form-label" style="display: none;">Payment Remarks</label>
...
var param = $('#frm_collect').serialize();
    ...
    $.post(URL+"webservice.php?action=getPreCollectDueInformation&method=Contracts&ID="+DueID,param,function(data){
        var obj = JSON.parse(data); 
        if (obj.status=="success") {
