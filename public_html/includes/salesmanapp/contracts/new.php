<div class="container-fluid p-0">
    ...
    <form id="frm_create" name="frm_create" method="post" enctype="multipart/form-data">
        <div class="row">
                ...
                <div class="card mb-2">
                    <div class="card-body" style="padding-bottom:0px;">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2" id="SchemeResult">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button  type="button" onclick="Confirmationtoadd()" class="btn btn-primary btn-sm" style="font-size: 10px;">Create Contract</button>
     </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="addNew()" class="btn btn-primary btn-sm">Yes, Create</button>
      </div>
    </div>
  </div>
</div>
          ...
          b.addEventListener("click", function(e) {
             ...
             $('#DueAmount').val(item.InstallmentAmount) ;
              txtHtml = '<div class="row">'
                                    ...
                                    + '</div>' 
                                    + '<div class="col-12">'
                                        + '<label class="form-label" style="font-weight:bold;margin-bottom:0px !important">Wastage Discount </label>&nbsp;:'
                                        + item.WastageDiscount + '&nbsp;<span>%</span>' 
                                    + '</div>'
                                    + '<div class="col-12">'
                                        + '<label class="form-label" style="font-weight:bold;margin-bottom:0px !important">Making Charge Discount</label>&nbsp:'
                                        + item.MakingChargeDiscount + '&nbsp;<span>%</span>'
                                    + '</div>' 
                                    + '<div class="col-sm-12" style="text-align:right;">'
