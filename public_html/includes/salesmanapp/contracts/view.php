<div class="container-fluid p-0">
    <div class="row">
        <div class="col-6">
            <h1 class="h3" style="font-weight: bold;">View Contract</h1>
        </div>
                        ...
                        <div class="col-6" style="text-align: right;padding-top:5px">
                            <table align="right">
                                <tr>
                                    ...
                                    <td style="line-height: 12px;text-align: right;"><span id="GoldInGrams" style="text-align: right;"><b id="GoldInGram">...</b><br><span style="font-size:10px">Gms</span></span></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-6">
 ...
 <div class="modal fade" id="Colseconfirmation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-6 mb-2">
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon3" style="width:190px">Making Charge Discount</span>
                    ...
                    <div class="col-sm-6 mb-2">
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon3" style="width:190px">Wastage Discount</span>
     ...
     <div class="modal-footer">
         <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal" style="font-size: 10px;">No</button>
         <button type="button" onclick="closeContract()" class="btn btn-danger btn-sm" style="font-size: 10px;">Yes, Continue</button>
     </div>
     </div>
    </div>
</div>   
...
<div class="modal-footer">
        <button type="button" class="btn btn-outline-primary btn-sm" data-bs-dismiss="modal" style="font-size: 10px;">Cancel</button>
        <button type="button" onclick="collectNew()" class="btn btn-primary btn-sm" style="font-size: 10px;">Pay</button>
      </div>
    </div>
  </div>
</div>
...
function getData(){
    ...
    $.post(URL+ "webservice.php?action=getData&method=Contracts&contract=<?php echo $_GET['view'];?>","",function(data){
        ...
        if (obj.status=="success") {
            ...
            $('#AddressLine3').html(CustomerData.AreaName +', '+CustomerData.DistrictName +','+CustomerData.StateName +'-' +CustomerData.PinCode );
            ...
            $('#GoldInGram').html(ContractData.GoldInGram);
                            ...
                            + '<div class="card mb-2">'
                                ...
                                if (duedata.ReceiptNumber!=""){ 
                                         html += '<div class="row">'
                                                     ...
                                                     +'</div>';
                                                      if(ContractData.VoucherID!="0"){
                                                             $('#ContractAdditionalInformation').html('<a href="'+URL+'dashboard.php?action=vouchers/voucher&number='+ContractData.VoucherNumber+'" class="btn btn-outline-primary btn-sm">View Voucher</a>');   
                                                            } else {
