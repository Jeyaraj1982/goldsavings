     ...
     <form id="frm_create" name="frm_create" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-12" style="text-align:right;">
                ...
                <button onclick="confirmationtoadd()" type="button" class="btn btn-primary btn-sm" style="font-size: 10px;">Create Customer</button>    
            </div>
        </div>
    </form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="addNew()" class="btn btn-primary btn-sm" style="font-size: 10px">Yes, Create</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    ...
    <form name="frm_create_districtname" id="frm_create_districtname">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="addNewDistrictName()" class="btn btn-primary btn-sm" style="font-size: 10px">Add District Name</button>
      </div>
     </form> 
    </div>
  </div>
...
<div class="modal fade" id="newarea" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form name="frm_create_areaname" id="frm_create_areaname">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-primary btn-sm" style="font-size: 10px" data-bs-dismiss="modal">Cancel</button>
        <button type="button" onclick="addNewAreaName()" class="btn btn-primary btn-sm" style="font-size: 10px">Add Area Name</button>
      </div>
     </form> 
    </div>
  </div>
...
<div class="modal fade" id="newcustomertype" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form name="frm_create_customertype" id="frm_create_customertype">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-primary btn-sm" style="font-size: 10px" data-bs-dismiss="modal">Cancel</button>
        <button type="button" onclick="addNewCustomerType()" class="btn btn-primary btn-sm" style="font-size: 10px">Add Customer Type</button>
      </div>
     </form> 
    </div>
  </div>
...
function addNew() {
   $('#confirmation').modal("hide"); 
    ...
    openPopup();
    clearDiv(['CustomerCode','Gender','CustomerTypeNameID','CustomerName','FatherName','EmailID','DateOfBirth','MobileNumber','WhatsappNumber','AddressLine1','StateNameID','DistrictNameID','AreaNameID','PinCode','RefMobileNumberID','ReferredBy','LoginUserName','LoginPassword','PancardNumber','AadhaarCardNumber']);
