                ...
                <div class="card">
                    <div class="card-body" style="padding-bottom:0px">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2" id="CustomerResult">
                            </div>
                        </div>
                    </div>
                </div>
          ...
          b.addEventListener("click", function(e) {
              ...
              txtHtml = '<div class="row">'
                                    ...
                                    + '<div class="col-sm-12" style="text-align:right;">'
                                        ...
                                        + '<a href="'+URL +'dashboard.php?action=customers/view&customer='+item.value+'&fpg=customers/search" class="btn btn-outline-primary btn-sm">View Details</a>'
                                    + '</div>';
