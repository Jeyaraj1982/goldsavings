    ...
    <div class="col-12 col-sm-12 col-xxl-12">
         <div class="card">
                ...
                <div class="col-sm-12" style="text-align:right;">
                    <a href="<?php echo URL;?>dashboard.php?action=profile/profile" class="btn btn-outline-primary btn-sm" style="font-size: 10px">Back</a>&nbsp;&nbsp;
                    <button onclick="confirmationtoadd()" type="button" class="btn btn-primary btn-sm" style="font-size: 10px">Change Password</button>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" style="font-size: 10px">No</button>
        <button type="button" onclick="changePassword()" class="btn btn-primary btn-sm" style="font-size: 10px">Yes, Change</button>
      </div>
    </div>
  </div>
</div>
