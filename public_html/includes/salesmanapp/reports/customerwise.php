       ...
       $.each(arr, function(i, item) {
        ...
        if ( (item.text.substr(0, val.length).toUpperCase() == val.toUpperCase()) ||  (item.MobileNumber.substr(0, val.length).toUpperCase() == val.toUpperCase()) ||  (item.CustomerID.substr(0, val.length).toUpperCase() == val.toUpperCase()) ) {
          ...
          html = "<span class='row' style='background:none;'>";
            ...
            html += "<span class='col-12' style='background:none'>"+item.CustomerName+"</span>";
            html += "<span class='col-6' style='background:none'>"+item.MobileNumber+"</span>";
            html += "<span class='col-6' style='background:none'>"+item.AreaName+"</span>";
          html += "</span>"
          ...
          b.addEventListener("click", function(e) {
              ...
              txtHtml = '<div class="row">'
                                    ...
                                    + '<div class="col-sm-12" style="text-align:right;">'
                                        ...
                                        + '<a href="'+URL+'dashboard.php?action=customers/view&customer='+item.CustomerID+'&fpg=reports/customerwise" class="btn btn-outline-primary btn-sm">View Details</a>'
                                    + '</div>';
