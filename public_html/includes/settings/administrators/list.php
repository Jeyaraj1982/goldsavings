<div class="container-fluid p-0">
     <div class="row">
        ...
        <div class="col-6" style="text-align:right;">
            <a href="<?php echo URL;?>dashboard.php?action=administrators/new" class="btn btn-primary btn-sm">New Administrator</a>
                             ...
                             + '<td style="text-align:right">' 
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=administrators/view&administrator='+data.AdministratorID+'&fpg=administrators/list">View</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=administrators/edit&administrator='+data.AdministratorID+'&fpg=administrators/list">Edit</a>'
                            ...
                            + '<td>' + ( (data.IsActive=="1") ? "<span class='badge bg-success'>Active</span>" : "<span class='badge bg-secondary'>Disabled</span>" ) + '</td>'
                             + '<td style="text-align:right">' 
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '</a>'
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=administrators/view&employees='+data.AdministratorsID+'&fpg=administrators/list">View</a>'
                                                + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=administrators/edit&employees='+data.AdministratorsID+'&fpg=administrators/list">Edit</a>'
