                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-12" style="text-align:right;">
                                <a style="color:#888;text-decoration:none;" href="<?php echo URL;?>dashboard.php?action=administrators/edit&administrator=<?php echo $data[0]['AdministratorID'];?>&fpg=administrators/view&administrator=<?php echo $data[0]['AdministratorID'];?>"><i class="align-middle me-2" data-feather="edit"></i><span class="align-middle">edit</span></a>
                            </div>
                            <div class="col-sm-6 mb-3">
                                <div style="font-weight: bold;">Administrator ID</div>
