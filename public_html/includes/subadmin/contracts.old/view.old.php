...
function closeContractForm(){
    ...
    $.post(URL+"webservice.php?action=getPreClosureContractInformation&method=Contracts&ContractID=<?php echo $_GET['view'];?>","",function(data){
        ...
        if (obj.status=="success") {
               ...
               $('#AdditionalNote').html("<div style='border: 1px solid red;background: yellow;border-radius: 5px;padding: 2px 5px;'><img src= '"+URL+"assets/lightbulb32.png' align='middle'>"+obj.data.AdditionalNote+"</div>");
