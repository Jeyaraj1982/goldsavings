                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-12 mb-3">
                                ...
                                <select class="form-select" name="SelectType" id="SelectType">
                                    ...
                                    <input type="text" name="FromDate" value="<?php echo date("d-m-Y");?>" id="FromDate" class="form-control" placeholder="From Date">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1">To</span>
                                </div>
                                <input type="text" name="ToDate" value="<?php echo date("d-m-Y");?>" id="ToDate" class="form-control" placeholder="To Date">
