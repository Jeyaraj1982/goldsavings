        ...
        <div class="col-3 col-sm-3 col-xxl-3">
            ...
            <div class="card-body" style="padding-top:25px">
                ...
                <tbody id="tbl_content">
                        <tr>
                        <td colspan="6" style="text-align: center;background:#fff !important">Loading Salesmans ...</td>
                        </tr>
                </tbody>
            </table>
        </div>
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align:right"><a href="javascript:void(0)" onclick="confirmationtoDelete(\''+data.AssignedAreaID+'\')" class="btn btn-outline-danger btn-sm">Delete</a>&nbsp;&nbsp;';
                            if (data.IsActive=="1"){
