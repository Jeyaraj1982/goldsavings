                ...
                <div class="card">
                    <div class="card-body" style="padding-bottom:0px">
                        ...
                        <div class="col-sm-3 mb-3">
                                ...
                                <input type="date" name="EntryDate" value="<?php echo date("Y-m-d");?>" id="EntryDate" class="form-control" placeholder="Entry Date">
          ...
          b.addEventListener("click", function(e) {
             ...
             $('#DueAmount').val(item.InstallmentAmount) 
              txtHtml = '<div class="row">'
                                    ...
                                    + '</div>' 
                                    + '<div class="col-sm-4">'
                                        + '<label class="form-label" style="font-weight:bold;margin-bottom:0px !important">Amount <span>(₹)</span></label><br>'
                                        +  item.Amount
                                    + '</div>'
                                    + '<div class="col-sm-4">'
...
function addNew() {
    ...
    openPopup();
    clearDiv(['CustomerName','CustomerID','SchemeID','MobileNumber','PaymentModeID','EntryDate','Amount','Installments','InstallmentMode','InstallmentAmount','MaterialType','ModeOfBenifits','Remarks','IsActive']);
