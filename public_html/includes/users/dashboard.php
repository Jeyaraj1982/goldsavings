                                ...
                                + '<div class="dropdown position-relative">'
                                        ...
                                        + '<div class="dropdown-menu dropdown-menu-end">'
                                                ...
                                                + '<a class="dropdown-item" href="javascript:void(0)" onclick="confirmationtoDelete(\''+data.CustomerID+'\')">Delete</a>';
                                                 if (data.ReferByText=="Customer") {
                                                      html += '<hr style="margin:0px !important">'
                                                            + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=customers/view&customer='+data.ReferredID+'">View Referral Info</a>';
                                                        } else if (data.ReferByText=="Salesman") {
                                                             html += '<hr style="margin:0px !important">'
                                                            + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=salesman/view&salesman='+data.ReferredID+'">View Referral Info</a>';
                                                        }  else if (data.ReferByText=="Employee") {
                                                             html += '<hr style="margin:0px !important">'
                                                            + '<a class="dropdown-item" href="'+URL+'dashboard.php?action=employees/view&employees='+data.ReferredID+'">View Referral Info</a>';
                                                        }  
