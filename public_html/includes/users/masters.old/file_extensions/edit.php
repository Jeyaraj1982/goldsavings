<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Edit File Extension</h1>
    <div class="row">
        <div class="col-12 col-xl-6">
            <div class="card">
                <div class="card-body">
                    <?php $data = $mysql->select("select * from _tbl_masters_file_extensions where FileExtensionID='".$_GET['edit']."'"); ?>
                    <form id="frm_edit" name="frm_edit">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" disabled="disabled" value="<?php echo $data[0]['ExtensionCode'];?>" class="form-control">
                                <span id="ErrBankNameCode" class="error_msg"></span>
                            </div>
                            <div class="col-sm-12 mb-3">
                                <label class="form-label">File Extension<span style='color:red'>*</span></label>
                                <input type="text" value="<?php echo $data[0]['FileExtension'];?>" name="FileExtension" id="FileExtension" class="form-control" placeholder="File Extension">
                            ...
                            <div class="col-sm-12" style="text-align:right;">
                                ...
                                <button onclick="confirmationtoUpdate()" type="button" class="btn btn-primary">Update File Extension</button>
                            </div>
                        </div>
                    </form>
...
function doUpdate() {
    ...
    openPopup();
    clearDiv(['FileExtension','Remarks']);
