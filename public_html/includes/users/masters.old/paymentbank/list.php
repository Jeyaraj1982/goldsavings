    ...
    <input type="hidden" value="<?php echo $data[0][' PaymentBankID'];?>" name="PaymentBankID" id=" PaymentBankID">
        <div class="row">
                            <div class="col-sm-6 mb-3">
                                <label class="form-label">Payment Bank Code <span style='color:red'>*</span></label>
    ...
    $('#AccountHolderName').keydown(function (e) {
      ...
      $('#AccountNumber').keydown(function (e) {
          if (e.ctrlKey || e.altKey || e.shiftKey) {
              ...
              var key = e.keyCode;
              if (!((key == 9) || (key == 8) || (key == 46) || (key >= 37 && key <= 40) || (key >= 48 && key <= 57) || (key >= 96 && key <= 105))) {
                  e.preventDefault();
              }
          }
      });
      $('#AccountHolderName').keydown(function (e) {
          ...
          if (e.ctrlKey || e.altKey || e.shiftKey) {
              ...
              var key = e.keyCode;
              if (!((key == 9) || (key == 8) || (key == 46) || (key >= 37 && key <= 40) || (key >= 65 && key <= 90) || (key >= 48 && key <= 57) || (key >= 96 && key <= 105)|| (key >= 92 && key <= 122))) {
                  e.preventDefault();
              }
          }
      });
