                ...
                <div class="card-body" style="padding-top:25px">
                    <table id="datatables-fixed-header" class="table table-striped" style="width:100%">
                        ...
                        <tbody id="tbl_content">
                            <tr>
                                <td colspan="3" style="text-align: center;background:#fff !important">Loading referrals ...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        if (obj.status=="success") {
            ...
            $.each(obj.data, function (index, data) {
                html += '<tr>'
                            ...
                            + '<td style="text-align:right"><a href="'+URL+'dashboard.php?action=masters/customers/view&customer='+data.CustomerID+'" class="btn btn-outline-primary btn-sm" style="font-size:10px">View</a></td>'
                      + '</tr>';
           });
