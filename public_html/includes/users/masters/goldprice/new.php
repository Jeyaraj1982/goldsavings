                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4 mb-3">
                                ...
                                <input type="date" value="<?php echo date("Y-m-d");?>" name="Date" id="Date" class="form-control" placeholder="PRICE">
                            ...
                            <div class="col-sm-12" style="text-align:right;">
                                ...
                                <button onclick="ConfirmationToAdd()" type="button" class="btn btn-primary">Create</button>    
                            </div>
                        </div>
                    </div>
                </div>
