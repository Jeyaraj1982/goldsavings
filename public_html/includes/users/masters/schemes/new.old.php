                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" style="text-align: right;" name="Installments" id="Installments" class="form-control" placeholder="Installments" data-masked="" data-inputmask="'mask':'99'">
                            ...
                            <script>
                             ...
                             <div class="col-sm-6 mb-3">
                                <label class="form-label">Based On <span style='color:red'>*</span></label>
