...
<div class="col-sm-12">
    <div class="row">
        <div class="col-6">
            <h1 class="h3">Customers report </h1>
        </div>
        <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <input class="form-check-input" type="checkbox" value="" id="EntryDate" name="EntryDate">
                                ...
                                <div class="col-sm-4 mb-3">
                                  <input class="form-check-input" type="checkbox" value="" id="FatherName" name="FatherName">&nbsp;
                                    Father Name
                                </div>
                                <div class="col-sm-4 mb-3">
                                  <input class="form-check-input" type="checkbox" value="" id="CreatedOn" name="CreatedOn">&nbsp;
                                    Created On
                                </div>
                                <div class="col-sm-4 mb-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div style="display:none" id="selectCustomerName">
                                    <div class="input-group">
                                        <select class="form-select" name="selectCustomerFilter" id="selectCustomerFilter">
                                ...
                                <div style="display:none" id="selectMobileNumber">
                                    <div class="input-group">
                                        <select class="form-select" name="selectMobileNumberFilter" id="selectMobileNumberFilter">
