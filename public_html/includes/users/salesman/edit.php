...
<div class="row">
        <div class="col-6">
        <h1 class="h3 mb-3">Edit Salesman</h1>
        </div>
    </div>
     <form id="frm_edit" name="frm_edit" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo $data[0]['SalesmanID'];?>" name="SalesmanID" id=SalesmanID">
        <div class="row">
            <div class="row">
    ...
    <div class="col-9 col-sm-9 col-xxl-9">
        <div class="card">
            ...
            <div class="col-sm-12 mb-3" style="text-align:right;">
                <a href="<?php echo URL;?>dashboard.php?action=salesman/list" class="btn btn-outline-primary">Back</a>&nbsp;&nbsp;
