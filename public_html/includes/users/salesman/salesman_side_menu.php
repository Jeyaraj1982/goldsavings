<div class="card mb-3">
    <div class="card-body text-center">
        ...
        <h4 class="card-title mb-0"><?php echo $data[0]['SalesmanName'];?></h4>
        <div class="text-muted mb-2"><?php echo $data[0]['SalesmanCode'];?></div>
        <div>
            <!--
    ...
    <ul style="text-align:left;" class="list-group list-group-flush">
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=salesman/view&salesman=<?php echo $_GET['salesman'];?>">Salesman Info</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=salesman/documents&salesman=<?php echo $_GET['salesman'];?>">Documents</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=salesman/payments&salesman=<?php echo $_GET['salesman'];?>">Payments</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=salesman/managearea&salesman=<?php echo $_GET['salesman'];?>">Manage Area</a></li>
        <li class="list-group-item"><a href="<?php echo URL;?>dashboard.php?action=salesman/activity&salesman=<?php echo $_GET['salesman'];?>">Activity</a></li> 
    </ul>
